...
The Codex templates contain only the 128 cases with neutral source context and reverse presentation order between files. Complete them in two isolated Codex passes with no prior outcome available, scoring both sides before selecting a winner, then ingest with:
