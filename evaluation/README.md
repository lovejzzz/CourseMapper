...
The Codex templates contain only the 63 cases with neutral source context and reverse presentation order between files. Complete them in two fresh Codex sessions with no prior outcome available, scoring both sides before selecting a winner, then ingest with:
