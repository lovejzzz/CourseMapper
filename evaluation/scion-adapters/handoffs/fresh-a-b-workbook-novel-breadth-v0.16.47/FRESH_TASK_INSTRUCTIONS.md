...
```bash
mkdir -p verification-output/scion-codex-fresh-a-b-working-v0.16.47
cp evaluation/scion-adapters/handoffs/fresh-a-b-workbook-v0.16.47/chunk-*-decisions-a-b.json verification-output/scion-codex-fresh-a-b-working-v0.16.47/
```
...
npm run complete:scion:codex-fresh-pass -- \
  --handoff evaluation/scion-adapters/handoffs/fresh-a-b-workbook-v0.16.47 \
  --receipt evaluation/scion-adapters/evidence/fresh-a-b-workbook-v0.16.47.json \
  --decisions-dir verification-output/scion-codex-fresh-a-b-working-v0.16.47 \
  --sealed-output verification-output/scion-codex-sealed-passes/v0.16.47-a-b.sealed.json \
  --key-output ~/.codex/scion-secrets/CourseMapper/v0.16.47-a-b.key
```
