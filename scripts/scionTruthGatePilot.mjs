  ...
  return [
    ...
    candidate({
      ...
      term: {
        ...
        mi: 'Every tuple is hashable simply because the outer tuple container is immutable.',
    ...
    candidate({
      ...
      term: {
        ...
        df: 'Deceptive motion most commonly moves dominant V to vi rather than moving that dominant to I.',
        eg: 'A dominant V moving to vi rather than I demonstrates the most common deceptive motion.',
        mi: 'The common deceptive pattern reverses the order, moving vi to V rather than moving V to vi.',
        cx: 'V is the starting harmony and vi is the destination; the common motion is V-to-vi, not vi-to-V.',
        sourceFactIndexes: [0],
      },
    }),
  ];
