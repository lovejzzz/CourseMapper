...
const patches = [
  {
    name: 'stream large OPFS reads through bounded destination views',
    before: [
  ...
  {
    name: 'cap each OPFS destination view below browser typed-array limits',
    before: 'const opfsHandles = {}; // map Name => { synchandle, size } for OPFS-backed files',
    after: [
  ...
  {
    name: 'reject invalid native action responses before allocating output',
    before: [
