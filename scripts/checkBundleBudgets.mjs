...
const repositoryBudgets = {
  // v0.16.94 advances the frozen state through the shipped v0.16.93 contract;
  // its own v0.16.94 contract consumes the single declared-release allowance.
  baselineVersion: '0.16.93',
  ...
  npmScripts: 384,
  // v0.16.93 shipped the 279th release-contract ledger file; v0.16.94 may add
  // exactly one current-release contract.
  releaseContractFiles: 279,
