...
const repositoryBudgets = {
  // v0.16.90 advances the frozen state through the shipped v0.16.89 contract;
  // its own v0.16.90 contract consumes the single declared-release allowance.
  baselineVersion: '0.16.89',
