...
const repositoryBudgets = {
  // v0.16.95 advances the frozen state through the shipped v0.16.94 contract;
  // its own v0.16.95 contract consumes the single declared-release allowance.
  baselineVersion: '0.16.94',
  ...
  npmScripts: 384,
  // v0.16.94 shipped the 280th release-contract ledger file; v0.16.95 may add
  // exactly one current-release contract.
  releaseContractFiles: 280,
