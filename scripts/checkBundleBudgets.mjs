...
const repositoryBudgets = {
  // V0.18.4 advances the frozen ledger through V0.18.3. Its own contract
  // consumes the single declared-release allowance.
  baselineVersion: '0.18.3',
  ...
  npmScripts: 402,
  // V0.18.3 closes with 308 tracked ledger files; V0.18.4 may add exactly
  // its one current-release contract.
  releaseContractFiles: 308,
