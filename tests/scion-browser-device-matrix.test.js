...
function browserManifest() {
  return {
    ...
    files: [
      ...
      { path: 'training-plan.json', bytes: 1024, sha256: HASH },
      { path: 'training-result.json', bytes: 1024, sha256: HASH },
      { path: 'source-adapter-manifest.json', bytes: 1024, sha256: HASH },
    ],
