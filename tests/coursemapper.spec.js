...
test.describe('Landing Page', () => {
  ...
  test('restored Scion workspaces never expose the internal model id', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Resume' }).click();
    await expect(page.getByTestId('workspace-header')).toContainText('Scion V0.16.37', { timeout: 10000 });
    await expect(page.getByTestId('workspace-model-config-trigger')).toHaveText('Scion V0.16.37');
