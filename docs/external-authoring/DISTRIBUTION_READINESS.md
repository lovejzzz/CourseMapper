...
The reviewer-access blocker is resolved. A fresh recorded ChatGPT-to-website workflow, the final policy attestations, submission and platform approval remain separate gates. These account checks do not establish public availability or replace the pending live interrupted-application and compatible rollback acceptance checks.
