...
Current development checkpoint: reviewed comparison practice now separates the complete task, diagnostic checks, independent transfer and an unscored revision, with rubric-based scoring and reversible upgrades from prior saved tasks. See the [v0.20.0 handoff](docs/v0.20.0-handoff.zh-CN.md) for remaining release gates and how to resume verification.
