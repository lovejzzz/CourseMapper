...
[EduTool.dev](https://edutool.dev) is an editable course-material workspace for educators. **v0.19.99** is a stabilization release of the existing website, preserving the **0.18.7 interface**, local Scion, all ten material categories, the existing editors and applicable exports.
