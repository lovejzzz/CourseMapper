...
- **Review / alignment** ("are quizzes aligned?", "check my course"): Use finalize_package first. It repairs safe readiness issues and returns confidence. If issues remain, use review_package_readiness plus validate_course or compare_deliverables. Respond with top remaining findings in plain English and only use proposal cards for instructor judgment calls.
