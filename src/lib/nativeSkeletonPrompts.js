...
6. sectionTitles are subject-matter subtopics only. Never use delivery modes or schedule labels such as "lecture", "lab", "laboratory", "workshop", "discussion", "seminar", or "recitation" as section titles by themselves; if the source gives only the session topic plus a lecture/lab format, omit sectionTitles or repeat the session topic. For a compact brief, give each session 2-4 specific subtopics and do not merely repeat the session title.
