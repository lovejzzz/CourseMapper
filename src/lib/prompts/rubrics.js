...
- NO GENERIC RUBRIC CELLS: Do not reuse criteria named "Objective alignment and task completion", "Use of course concepts and evidence", "Reasoning, organization, and communication", or "Communication and submission quality" unless the phrase is expanded with a lesson-specific method, artifact, data source, or decision. If two rubrics share the same assessment type, their criteria and performance descriptors must still name different lesson evidence.
- LESSON-SPECIFIC EXAMPLES: Every performance-level example must include at least one concrete noun from that lesson's topic, assessment, data/source type, case, tool, or output. Avoid generic examples like "the response cites a relevant concept" or "the submission names the objective".
