...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.52 Proves the Last Mile',
  highlights: [
  ...
  landingHighlights: [
    'A real Scion build reached 99/A in 37 seconds with all selected materials ready.',
    'Free-form Agent chat answered through the local Scion model in about six seconds.',
    'Ready packages offer review and improvement—not a redundant finish pass.',
    'ZIP preparation is named, and the physical archive passes integrity checks.',
    'Desktop and 390×844 phone workspaces have no document-level overflow.',
    'Frozen semantic evidence is hash-bound and checked by the normal test suite.',
    'Gemma weights remain unchanged and no quality adapter is active.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.52.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Run the real workflow, not a screenshot demo',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The release candidate was driven from a fresh Public Health example through materials, lesson scope, generation, compiler completion, Agent audit, free-form Agent chat, phone switching, and physical ZIP export.',
        'With the pinned public base already cached, the one-lesson build advanced through all six observable stages and reached terminal ready in 37 seconds. Five of five selected materials compiled; the deterministic package result was 99/A with texture 94.',
        'The Agent’s local audit found one readability review item without claiming edits. A separate free-form question received a grounded Scion response in about six seconds, proving that the chat surface is connected to the local model rather than a decorative shell.',
        'Desktop 1440×1000 and phone 390×844 measurements both reported document scroll width equal to client width. Content, Agent, and Export switching remained operable on the phone.',
      ],
    },
    {
      label: 'Let finished work stay finished',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'The completed 99/A workspace still offered Finish package as its first Agent starter. Clicking it would rerun verification, repair, grading, and export preparation even though the same ready receipt already proved completion.',
        'Ready receipts now change both language and action priority. The Agent says the package is ready, keeps the starting brief in context, and offers review or improvement actions instead of an obsolete finalizer.',
        'Unfinished packages keep the original Finish package path, so the change removes duplicate work without weakening the finish gate.',
      ],
    },
    {
      label: 'Name the last mile and verify the file',
      icon: 'CHECK',
      color: 'violet',
      items: [
        'The ZIP button previously replaced its icon with a spinner but kept saying Download ZIP throughout archive assembly. It now says Preparing ZIP… and remains disabled until the work completes.',
        'The browser-created archive is 88,136 bytes with SHA-256 8149385a425738120d467e442bd814373481389b9839baf8d8c48210030eeb81. Independent unzip verification reports no compressed-data errors.',
        'The archive contains Course Map, Syllabus, Lesson Plans, Assignment Briefs, Rubrics, Quiz & Exam Bank, source report, manifest, and quality report entries. Its manifest carries the same 99/A and texture 94 shown in the workspace.',
      ],
    },
    {
      label: 'Keep the dark hierarchy readable',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'The global dark-surface rule intentionally remaps white backgrounds to stable dark surfaces, but the Course structure badge still paired that remapped background with slate-950 text.',
        'Always included now declares an explicit dark background and white text. The badge retains its compact hierarchy without disappearing into the card.',
        'Amber remains reserved for actual review attention; the downloadable package state continues to use calm blue information styling.',
      ],
    },
    {
      label: 'Make the frozen ruler survive regeneration',
      icon: 'CHECK',
      color: 'violet',
      items: [
        'The audit found that the semantic-admission burden metrics still passed while its tracked hashes referenced an earlier serialization of all twelve retained replay projects. The upstream source-compiler receipt already carried the current hashes, so the downstream receipt was provably stale.',
        'Protocol v2 now binds that upstream receipt by byte count and SHA-256, checks the exact v0.16.47 release identity, and refuses any project whose bytes or hash differ from the upstream project ledger.',
        'A default-suite regression test executes the tracked-receipt verifier. Future replay regeneration cannot leave stale downstream evidence behind while ordinary CI stays green.',
        'The measured result itself does not change: source-strict V4 adds two reviewed retry atoms across 192 retained seats, changes no eligibility decision across either arm of 91 frozen pairs, and detects all 78 stable weak artifacts with zero preferred regressions.',
        'No Gemma weight changed, no adapter was activated, and no paid-reference parity, human review, classroom outcome, or universal quality claim is added by this release.',
      ],
    },
  ],
};
