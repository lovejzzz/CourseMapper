...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    ...
    },
    {
      ...
      color: 'blue',
      items: [
        'MLX-VLM 0.6.3 does not expose a seed flag even though it uses NumPy permutation and MLX random initialization. The Scion wrapper sets both generators before importing the trainer, and the launcher supplies every parameter explicitly rather than inheriting changing library defaults.',
