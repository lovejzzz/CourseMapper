...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.69 Closes the Quality Freeze and Geology Regression',
  highlights: [
  ...
  landingHighlights: [
    'Fifteen Mandarin lessons receive exact, attributed source facts.',
    'Trusted compiler facts need zero extra model inference.',
    'Full-width Chinese punctuation survives semantic admission.',
  ...
  proof: {
    contract: 'release-contracts/v0.16.69.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01669_SOURCE_LEDGER_FREEZE.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Give Mandarin an exact source boundary',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'CHN101 Elementary Mandarin I supplies three canonical, lesson-specific facts for each of the 15 requested identities, with URL, license, and attribution retained as one trusted ledger.',
        'Instructor-supplied facts continue to win. The deterministic ledger activates only when Course Mapper owns an exact matching source contract; it does not invent knowledge for arbitrary courses.',
        'Direct title and topic matches outrank broad review anchors, and boundary-aware matching prevents substring collisions across unrelated lessons.',
      ],
    },
    {
      label: 'Spend model inference where it adds value',
      icon: 'CHECK',
      color: 'emerald',
      items: [
    ...
    {
      label: 'Keep valid language knowledge intact',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'Display pairs and canonical facts are NFKC-normalized before safety comparison, so Chinese full-width punctuation cannot invalidate a semantically identical fact.',
        'The corrected negation example uses 我不喜欢苹果。 and lesson identity matching no longer confuses Shopping, Introductions, Age, Passages, or Hanzi.',
        'The Mandarin artifact proof inspects lesson-specific quiz documents, not merely the in-app score or course JSON.',
      ],
    },
    {
      label: 'Inspect the files the instructor receives',
      icon: 'PROOF',
      color: 'violet',
      items: [
        ...
        'Compact focus labels discard introductory prepositions, possessive owners, and cross-conjunction adjective piles, so “Introduction to Earth Systems,” “Erikson’s Psychosocial Development,” and the long diurnal-motion title remain grammatical after repetition reduction.',
        'The final document boundary restores narrow title-case possessives such as “Earth’s Structure” and removes seams such as “today’s the” and “a solid the” without changing ordinary plural text.',
      ],
    },
    {
      label: 'Present a finished product',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Current Scion-facing safety copy says AI-generated materials, never AI draft.',
        'The export panel remains the sole ZIP owner, with one Download ZIP action and no unfinished archive label.',
        'Readiness is still honest: zero-blocker claims come from successful compilation, verification, grading, archive testing, and document inspection—not from hiding warnings.',
      ],
    },
    {
      label: 'Freeze five domains at artifact level',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'Mandarin, World Literature, Psychology, Nutrition, and Astronomy each complete all ten sections, 38/38 export checks, zero blockers, zero warnings, and 99/A with zero P0/P1/P2 findings.',
        'Their valid archives contain 127, 117, 125, 117, and 101 extracted files respectively.',
        'The audit checks representative DOCX content and clean console receipts in addition to the manifest, quality report, archive integrity, and score.',
        'A sixth fresh Physical Geology browser package reaches 99/A, 38/38 export checks, zero findings, blockers, or warnings, and 117 tested files; the exact missing Final (50%) incident remains bound to its dedicated deterministic regression.',
      ],
    },
    {
      ...
      items: [
        ...
        'Unicode admission, answer projection, assessment rendering, compilation, and export checks are model-neutral and benefit compatible paid-provider routes. The exact Mandarin source-ledger shortcut is Scion compiler knowledge and activates only for its owned source contract.',
        'The result is deterministic package-defect conformance, not factual verification, instructor approval, classroom evidence, or a promise that every possible course earns 99/A.',
      ],
    },
  ],
};
