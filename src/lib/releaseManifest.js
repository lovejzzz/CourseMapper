...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.71 Ships a Premium Green Package',
  highlights: [
    'The supplied Physical Geology ZIP and console log are audited at the artifact boundary: the archive is healthy, but its registered Final (50%) assessment is missing from the exam content, producing the real 74/C P0 rather than an export failure.',
    'A fresh exact pinned-base Geology browser run now finishes in 55 seconds with three provider calls, 14/14 admitted kernels, nine compiled material families, 38/38 export checks, a valid 118-file archive, and 99/A with zero P0/P1/P2 findings, blockers, warnings, retries, console errors, or archive errors.',
    'Package trust now treats a zero-finding A/B result as green even when its transparent score or texture meter is below a mathematically perfect 100. Actual findings, low grades, source caveats, export warnings, and failures keep their review or blocked treatment.',
    'Primary package UX uses finished-product language, one Download ZIP action, Ready to download success copy, and AI-generated provenance. Assignment exports now honor explicit related-lesson identity before due-week metadata, so a Lesson 1 brief due in Week 4 cannot disappear as a fictional Lesson 4 item. Legacy draft wording remains only in historical records, internal compatibility, or pedagogically correct learner-work contexts.',
    'Oversized local saves now fall back to a compact course-map recovery snapshot, so a browser quota error cannot erase a completed map or force a full model rerun.',
    'World Literature gains passage-based reading tasks, a stronger conceptual spine, reading-specific evidence prompts, criterion-varied rubric language, and a meaningful 16% final paper without adding a rewrite cascade.',
    'The fresh 14-lesson World Literature browser package reaches 98/A with zero P0/P1, no blockers, no retries, 38/38 export checks, and 117 files; a no-model compiler replay clears its remaining repetition P2 while preserving the exact model material.',
    'Anonymous complete-artifact review stays honest: the paid reference beats Scion in both presentation orders, 71–44 and 63–45. Scion’s alignment and grading structure improve, but shallow concepts, circular assessment language, and factual overreach remain the next quality frontier.',
    'The production architecture avoids the former 72-call failure shape: Geology uses three provider calls and World Literature uses thirteen actual generations, while deterministic compilation supplies all nine downstream material families.',
    'Gemma weights remain unchanged and the research adapter remains inactive. Compiler, trust, persistence, assessment, language, grading, and export repairs are model-neutral and benefit compatible paid-provider routes; browser-local download and inference remain Scion-specific.',
  ],
  landingHighlights: [
    'The supplied Geology failure is closed by a fresh 99/A, zero-finding browser package.',
    'Ready means green when every actionable check passes.',
    'One premium Download ZIP action owns the finished package.',
    'Local-save recovery protects completed maps from browser quota limits.',
    'World Literature gains passage-based tasks and a stronger final-paper plan.',
    'The paid reference still wins blind review, defining the next quality target honestly.',
    'Three-call Geology and thirteen-generation Literature runs stay far below the former 72-call shape.',
    'The adapter remains inactive and Gemma weights remain unchanged.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.71.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01671_PREMIUM_ZERO_BLOCKER.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Close the supplied Geology failure',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'The received archive passes integrity and export checks, but the manifest’s Final (50%) assessment has no corresponding exam content.',
        'Explicit exam titles now override contradictory generic assessment kinds across graph, IR, registry, compiler, and export boundaries.',
        'The fresh pinned-base run admits all 14 lesson kernels, compiles every selected material family, passes 38/38 export checks, and opens to 118 files.',
        'Its terminal state is ready at 99/A with zero encoded findings, blockers, warnings, retries, console errors, or archive errors.',
      ],
    },
    {
      label: 'Make the green light semantically true',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'A zero-finding A/B package no longer becomes amber merely because score or texture is below 100.',
        'The exact score and texture meter remain visible; the treatment changes only the actionable trust state.',
        'Any real finding, low grade, source caveat, export warning, or failed export still produces review or blocked language.',
        'The ready card, workspace quality chip, compiler checks, and package button now agree on one green terminal state.',
      ],
    },
    {
      label: 'Present a finished product and protect it locally',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The package surface has one Download ZIP owner and no unfinished archive label.',
        'Scion-facing provenance says AI-generated; product expansion copy says create rather than draft.',
        'Assignment ownership follows the related lesson before its due week, keeping current-tab CSV and DOCX export truthfully ready.',
        'A compact course-map snapshot is persisted when the full workspace exceeds local browser quota.',
        'Recovery keeps the completed map available without requiring another model generation.',
      ],
    },
    {
      label: 'Deepen literature at the compiler boundary',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'Named readings receive locatable-passage tasks, counter-readings, contextual boundaries, and revision moves.',
        'The grading plan assigns 16% to the final paper and 5% to its proposal instead of burying culmination under weekly micro-weights.',
        'Rubric self-assessment and analytical bands vary by lesson while preserving their actual criteria.',
        'The fresh browser package reaches 98/A, and the final no-model replay removes the remaining repetition finding.',
      ],
    },
    {
      label: 'Use blind review to name the real gap',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'The same anonymous packets are reviewed in A/B and reversed B/A order.',
        'The paid reference wins both orders, 71–44 and 63–45, at 96 and 94 confidence.',
        'Scion wins on consistent evidence/revision structure and a coherent 16% culmination weight.',
        'The next target is richer concept definition, less circular assessment language, and tighter factual boundaries—not more status-color polish.',
      ],
    },
    {
      label: 'Keep the architecture efficient and the claim bounded',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'Geology uses three provider calls; World Literature uses thirteen actual generations and zero retries rather than a 72-call repair cascade.',
        'The deterministic compiler produces all nine downstream material families from admitted course and lesson knowledge.',
        'Gemma weights are unchanged and the research adapter remains inactive.',
        'The evidence proves these artifacts and failure classes—not universal factual correctness, classroom outcomes, instructor approval, or paid-model parity.',
      ],
    },
  ],
};
