...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Make the quality seal current and complete',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'A grader-version mismatch forces a fresh grade before the package can inherit a clean seal.',
        'Each lesson records its required sources, artifacts, assessments, and resolution state.',
        'Unresolved lesson evidence blocks readiness with a named P0 finding.',
      ],
    },
    {
      label: 'Repair what learners and instructors read',
      icon: 'AI',
      color: 'blue',
      items: [
        'Assignments receive concrete submission directions instead of missing-configuration deferrals.',
        'Definitions state domain meaning before instructional use, and malformed prose is repaired or rejected.',
        'Long courses vary the final quiz slot by lesson focus instead of cycling the same distractors.',
      ],
    },
    {
      label: 'Render the package as carefully as it is graded',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'DOCX tables keep semantic rows together, mark headers, and avoid unconditional page breaks.',
        'Slides keep decorative geometry on-canvas and use complete, concise reader-visible copy.',
        'Fresh rendered artifacts pass the retained format and accessibility checks within an explicit claim boundary.',
      ],
    },
  ],
};
