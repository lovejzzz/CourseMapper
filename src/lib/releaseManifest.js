...
export const CURRENT_RELEASE = {
  ...
  highlights: [
    ...
    'Scion remains the sole public product identity. On capable devices it uses local Gemma; on incompatible or storage-constrained devices it automatically uses the private source-evidence and deterministic compiler lane inherited from the Algi research prototype. The UI, Agent, progress, and export continue to speak as Scion, while model-request accounting stays honestly at zero.',
    ...
    'A fresh local Chrome acceptance build completes a three-lesson Digital Accessibility course in about seven seconds with 3/3 kernels, 9/9 material families, zero blockers or warnings, 69/100 Automated Readiness at the unchanged automation ceiling, 99/A package conformance, texture 96, and 38/38 physical ZIP checks across 27 files. This is local engineering proof, not production or instructor validation.',
    'The acceptance pass repairs visible language and provenance at their source: stale W3C navigation, alternate-version, and markup-aside fragments fail admission; W3C/WAI attribution survives compilation; the Agent progressively loads only the narrow answer capability requested and states each source boundary; and public Scion exports contain no internal Algi codename.',
  ],
  landingHighlights: [
