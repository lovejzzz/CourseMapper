...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Stop false-green quality proof',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Every reusable quality receipt is bound to the exact package scope and quality-policy versions.',
        'Pipeline narration and internal reference wiring no longer create evidence-grounding points.',
        'A protocol with no recorded comparison evidence exits the release gate nonzero.',
      ],
    },
    {
      label: 'Keep weak semantics visible',
      icon: 'AI',
      color: 'blue',
      items: [
        'The compiler may format or reject repeated misconception prose, but it may not invent a replacement claim.',
        'Extraction receipts retain source ID, locator, quotation, and check details while denying semantic-support credit.',
        'Missing disciplinary definitions remain explicit unresolved findings after honesty repair.',
      ],
    },
    {
      label: 'Separate engineering quality from teaching proof',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'Reader-visible repetition and formatting regressions have deterministic coverage.',
        'External instructor preflight is binding, so missing teaching evidence cannot be called a quality checkpoint.',
        'The architecture audit preserves the real Gemma failures and the still-unresolved model-versus-pipeline attribution.',
      ],
    },
  ],
};
