...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.68 Turns Physical Geology Fully Green',
  highlights: [
    'The attached V0.16.67 Physical Geology package is audited at the artifact and console level: it was a valid archive but graded 74/C because Geology was misclassified as Nutrition, “Final (50%)” was not compiled as an exam, Lesson 14 fell into assessment recovery, and the compact local-save fallback remained too large.',
    'Physical Geology now has a dedicated discipline lens, and nutrition detection no longer treats the word “mineral” alone as proof of a nutrition course. Diet-analysis and nutrient-language contamination cannot enter the Geology compiler path.',
    'An explicit exam title now overrides a contradictory generic model kind at the native graph, course IR, registry, and compiler boundaries, so “Final (50%)” produces a real exam instead of a missing artifact.',
    'Fragment-specific source keys resolve to their trusted base bibliography entry, preserving URL, attribution, license, and concept linkage instead of downgrading a valid source to review-only status.',
    'When a full local save exceeds browser quota, Course Mapper now writes a deliberately small course-map recovery snapshot without the compiled graph, material payloads, or edit history, preserving the work needed to recompile on open.',
    'The export surface speaks like a finished product: one enabled Download ZIP button, a ZIP downloaded confirmation, and review notes inside the package without an unfinished package label.',
    'A fresh exact Geology run completes 14/14 lessons, 14/14 knowledge kernels, 9/9 material families, and 38/38 export checks in 57 seconds with four model calls and zero retries. The 117-file ZIP grades 99/A with citation score 100 and zero P0/P1/P2 findings.',
    'The frozen base-only matrix closes at 99/A with zero findings across Astronomy, Mandarin, Nutrition, Psychology, and World Literature. A shared-license attribution false positive found by the matrix is fixed without weakening checks on actual off-topic readings.',
    'The release passes 432 unit test files and 5,292 tests, format, lint, production build, locked bundle budgets, browser DOM/export inspection, archive testing, and independent regrading. Gemma weights remain unchanged and the research adapter remains inactive.',
  ],
  landingHighlights: [
    'Physical Geology stays Geology—never nutrition by keyword accident.',
    '“Final (50%)” compiles into a real exam across every registry boundary.',
    'Trusted source fragments retain their URL, license, and attribution.',
    'Local-save recovery preserves the course map without exceeding browser quota.',
    'The package surface uses one clear Download ZIP action.',
    'The exact 14-lesson Geology run reaches 99/A with zero findings.',
    'All five frozen base-only domains reach 99/A with zero findings.',
    'The full suite passes 5,292 tests and every local release gate.',
    'Gemma weights are unchanged and the research adapter remains inactive.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.68.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01668_GEOLOGY_ZERO_BLOCKER.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Read the failure from the package, not the banner',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'The received Physical Geology ZIP passed archive and 38/38 physical export checks while the content grader correctly kept it from a green state.',
        'The root causes were separate: discipline misclassification, contradictory assessment typing, source-fragment metadata loss, and an oversized compact autosave retry.',
        'The audit uses rendered course files, package metadata, source ledger, console receipts, and the real download rather than treating a successful generation callback as proof of quality.',
      ],
    },
    {
      label: 'Keep Geology in the correct discipline',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Physical Geology has its own field, sample, Earth-process, and geologic-interpretation lens before the generic domain fallback.',
        'Nutrition keeps genuine diet, nutrient, vitamin, electrolyte, protein, carbohydrate, and lipid cues but no longer claims any course containing the word mineral.',
        'A focused regression proves a mineral-identification course receives Geology language, while the frozen Nutrition package remains 99/A.',
      ],
    },
    {
      label: 'Compile the exam the course actually requested',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'Title classification can override a contradictory generic kind from model output, saved graphs, templates, or the course IR when the assessment is explicitly a final or exam.',
        'The exact Final (50%) regression now creates a populated Quiz & Exam Bank artifact and keeps the manifest and compiler registry in agreement.',
      ],
    },
    {
      label: 'Preserve source trust and recover local saves',
      icon: 'LIVE',
      color: 'violet',
      items: [
        'A section anchor such as source-key#section resolves its URL, license, and attribution from the exact base source when the fragment-specific entry is absent.',
        'If full and compact snapshots exceed local storage, the emergency snapshot keeps the prompt, course map, configuration, manifest, and recompile marker while dropping the graph, compiled materials, and history.',
        'Unit tests prove both behaviors and the fresh Geology source ledger contains one trusted, accessible, concept-linked source with no review rows.',
      ],
    },
    {
      label: 'Present one premium package action',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The package panel has one clear Download ZIP action. Its progress state is Finishing package, and successful completion confirms ZIP downloaded.',
        'Review information remains available inside the package without labeling the downloadable archive as unfinished.',
        'The exact Geology replay finishes ready with 14/14 lessons, 9/9 families, 38/38 export checks, zero blockers, zero warnings, and a valid 117-file ZIP.',
      ],
    },
    {
      label: 'Freeze the shared compiler across five domains',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'Astronomy, Mandarin, Nutrition, Psychology, and World Literature all grade 99/A with zero P0/P1/P2 findings on the exact pinned public base with the adapter inactive.',
        'The matrix found one evaluator bug: shared Creative Commons attribution metadata was parsed as a reading. The repair excludes only the metadata paragraph; actual off-topic encyclopedia entries remain graded.',
        'The complete suite passes 432 files and 5,292 tests, plus format, lint, production build, bundle budgets, real ZIP generation, archive testing, and independent regrading.',
      ],
    },
    {
      ...
      color: 'emerald',
      items: [
        'The pinned public Gemma 4 E2B weights are unchanged and the research adapter remains inactive. This release changes discipline classification, assessment routing, source metadata, persistence, grading, export wording, and tests.',
        'Those compiler and evaluator boundaries are model-neutral; compatible paid-provider routes inherit them. WebGPU execution, model download, caching, and browser-runtime recovery remain Scion-specific.',
        'The result is deterministic package-defect conformance, not factual verification, instructor approval, classroom evidence, or a promise that every course earns 99/A.',
      ],
    },
  ],
};
