...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.75 Recovers Saved Courses Locally and Finishes Green',
  highlights: [
    'The exact saved GPT-5.4 Mini World Literature project that opened with four failed material families now finishes without its API key: one local compiler pass restores 9/9 materials, reaches 99/A with texture 92 and zero P0/P1/P2 findings, and ends at Ready to download.',
    'Finalization treats the nine standard downstream material families as compiler-owned work. Four missing families are rebuilt together from the admitted course blueprint instead of rebuilding the same blueprint four times or asking the paid provider again.',
    'Finish accounting now records actual provider work returned by the generation route. The recovery uses zero provider calls even though four repair actions were planned; estimated work remains a budget ceiling rather than being reported as spend.',
    'A successful local compile replaces a stale blueprint-compiler failure receipt with “Recovered locally: 4 materials compiled from the current blueprint,” so the exported provenance describes the package that exists now.',
    'Legacy saved assignment briefs receive the current deterministic title-compaction repair during finalization. The Lesson 8 Borges brief falls from nine full-title repetitions to two identity/provenance mentions while preserving its title and Related Lessons.',
    'The browser finish takes about 39 seconds, presents calm local-rebuild progress, exposes one enabled Download ZIP action, and produces a 1.33 MB archive whose 79 entries pass integrity testing with 10/10 sections ready and 38/38 export checks.',
    'The full local release gates retain the locked landing, Living Course Compiler, and AppFlow bundle ceilings; the recovery code does not purchase behavior by raising a size budget.',
    'Gemma weights remain unchanged and the research adapter remains inactive. Finalization, compiler recovery, legacy migration, provider-call accounting, grading, and export are shared with compatible provider routes; only the public model download and browser inference are Scion-specific.',
  ],
  landingHighlights: [
    'Saved paid-model courses can recover compiler-owned materials offline.',
    'Four missing material families rebuild in one local pass.',
    'Actual provider calls stay at zero during local recovery.',
    'Legacy repeated-title copy is repaired before export.',
    'The package finishes at 99/A with zero findings.',
    'One Download ZIP action produces a verified archive.',
    'Recovery provenance replaces stale failure history.',
    'The adapter stays inactive and Gemma weights stay unchanged.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.75.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01675_LEGACY_RECOVERY_ACCEPTANCE.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Recover locally',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'An imported GPT-5.4 Mini project does not need its old API key to rebuild compiler-owned materials.',
        'Discussion Prompts, Quiz & Exam Bank, Study Guides, and Course FAQ compile together from the saved blueprint.',
        'The finalizer remains fail-closed: only the standard deterministic compiler families use this offline route.',
        'The real browser package moves from 5/9 and four failures to 9/9 and Ready to download.',
      ],
    },
    {
      label: 'Count real work',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'Generation routes return their observed provider-call count to the finalizer.',
        'Local compiler work reports zero calls instead of inheriting the estimated repair-action count.',
        'Provider-call budgets decrement by actual work while estimates remain conservative ceilings.',
        'The restored pipeline receipt names four locally recovered materials and removes the obsolete failure sentence.',
      ],
    },
    {
      label: 'Migrate old copy safely',
      icon: 'CHECK',
      color: 'violet',
      items: [
        'Current assignment-body compaction now runs against legacy saved deliverables during package finalization.',
        'The learner-facing Borges brief no longer repeats its long title through every instruction line.',
        'Identity fields and Related Lessons remain exact; the repair is idempotent on a second finalization.',
        'Compatible local and paid-provider projects receive the same deterministic migration.',
      ],
    },
    {
      label: 'Prove the physical package',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The recovered workspace reaches 99/A, texture 92, zero findings, zero blockers, and zero warnings.',
        'The manifest records all eight named readings, 10/10 checked sections, and 38/38 export verification.',
        'Exactly one enabled Download ZIP control creates the physical 1.33 MB archive.',
        'All 79 ZIP entries pass compressed-data testing, including Unicode-named Lesson 8 files.',
      ],
    },
    {
      label: 'Keep recovery efficient',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'The browser finish completes its local repair and verification task in about 39 seconds.',
        'One blueprint build replaces the preceding repeated per-feature rebuild shape.',
        'Local progress copy says what is being rebuilt without presenting internal recovery as a user failure.',
        'Landing, Living Course Compiler, AppFlow, and compiler chunks remain within the existing locked budgets.',
      ],
    },
    {
      ...
      items: [
        ...
        'The saved incident was generated by GPT-5.4 Mini; its improvement comes from the shared compiler and migration path, not a hidden model rerun.',
        'Compatible providers benefit from the same compiler recovery, title compaction, accounting, grading, and export changes.',
        'This is one bounded browser and artifact recovery proof—not universal factual correctness, instructor approval, classroom outcomes, adapter superiority, or paid-reference parity.',
      ],
    },
  ],
};
