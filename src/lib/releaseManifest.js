...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.72 Proves the Five-Domain Base',
  highlights: [
    'One exact base-only browser freeze now completes Mandarin, World Literature, Psychology, Nutrition, and Astronomy at 99/A each, with every requested lesson, all ten material sections, 100% usable kernel coverage, zero blockers, warnings, P0/P1/P2 findings, retries, or failed export checks.',
  ...
  landingHighlights: [
    'Five frozen domains finish at 99/A with zero encoded findings.',
    'Every package is ready, warning-free, and physically downloadable.',
    'World Literature keeps every integrator lesson and assigned-text boundary.',
    'Mandarin preserves all 15 kernels with zero retries.',
    'Psychology loses its false blocker and readability warning.',
    'Cross-concept assessments now demand evidence-bounded reasoning.',
    'Forty calls build five courses; retries remain zero.',
    'The adapter stays inactive and Gemma weights stay unchanged.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.72.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01672_FIVE_DOMAIN_FREEZE.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Freeze the complete base system',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'One sequential browser round uses the same pinned base, compiler, grader, authoring mode, and zero-cost local route for all five held-out courses.',
        'All five finish at 99/A with zero blockers, warnings, P0/P1/P2 findings, retries, or failed export checks.',
        'Kernel coverage is 100%, all ten material sections are ready, and every requested lesson remains present.',
        'The five tested ZIPs contain 587 extracted files and pass physical archive verification.',
      ],
    },
    {
      label: 'Repair literature and language at the source boundary',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'Comparative-reading integrators reuse verbatim facts from earlier assigned-text kernels and carry explicit projection provenance.',
        'World Literature moves from 89/B blocked with one missing kernel and six recovery items to 99/A and 14/14 admitted kernels.',
        'The exact Mandarin brief reconciles fourteen named clauses with its requested fifteen lessons through one bounded retrieval bridge.',
        'Unicode-aware word counting recognizes Hanzi evidence, so a valid grammar kernel becomes a usable lesson instead of two futile retries.',
      ],
    },
    {
      label: 'Remove false blockers without weakening the gate',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'Artifact-contamination detection requires the focus cue to precede and stay near the artifact term, eliminating a Psychology speaker-note false positive.',
        'Assessment reconciliation carries stable IDs through blueprint, assignment, rubric, map, and syllabus candidates before comparing display titles.',
        'Hidden quiz-planning and instructor-feedback metadata no longer count as learner-paper readability.',
        'The fresh Psychology package has zero blockers, warnings, findings, or missing-artifact claims.',
      ],
    },
    {
      label: 'Make assessment reasoning explicit',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'All six cross-concept exam frames ask learners to select concepts rather than receive them as cues.',
        'Each frame requires one distinct evidence detail per concept, an explicit relationship, and a limitation or unsupported extension.',
        'Visible questions, answer guidance, model answers, and scoring directions use shorter sentences without losing the evidence boundary.',
        'Mandarin clears its prior constructed-response P2 with no additional inference.',
      ],
    },
    {
      label: 'Keep failures inspectable and calls bounded',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'A blocked finalization now preserves the in-memory forensic ZIP and waits through autosave before capturing project state.',
        'The exact freeze uses 40 provider calls across five courses and zero repair or finish retries.',
        'No entire course is regenerated to solve one missing lesson; source-owned evidence is projected locally where safe.',
        'Digest, console, extracted artifact, and ZIP evidence remain bound to one round identity.',
      ],
    },
    {
