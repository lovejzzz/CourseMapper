...
export const CURRENT_RELEASE = {
  ...
  highlights: [
    ...
    'This release makes future adapter training reproducible and promotion-auditable; it does not complete the fresh B/A judgment, create approved preferences, train new quality weights, activate an adapter on the public site, or claim a model win. Hosted Scion remains base-only plus compiler.',
  ],
  landingHighlights: [
    ...
    'No new weights, judgment, or model-quality win is claimed.',
  ],
  proof: {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        'A completion receipt binds the plan, adapter configuration, weight bytes, completion time, and a digest of the locally retained training log. The raw log stays outside the distributed adapter package; the manifest carries only its signed digest through the result receipt.',
        ...
        'This is reproducible-training infrastructure, not a quality result. The fresh reverse-order judgment, stable approved preferences, new research weights, five-domain adapter win, paid-reference parity, and three remaining device profiles are still missing.',
      ],
    },
  ],
};
