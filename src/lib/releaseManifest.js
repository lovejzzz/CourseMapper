...
export const CURRENT_RELEASE = {
  version: APP_VERSION,
  date: 'July 17, 2026',
  title: 'Open the Lab, Not Production: authorize one evidence-bound Scion adapter experiment',
  landingTitle: 'Scion Reaches 143 Strict Training Rows—Enough to Test an Adapter, Not Claim a Win',
  highlights: [
    ...
    'This release authorizes an experiment, not a product claim: no adapter is active or promoted, the corpus is not production-license-compatible, and single-model Codex judgment is not human, instructor, classroom, or paid-reference-parity evidence.',
  ],
  landingHighlights: [
    '143 strict, source-bound preferences across seven domains.',
    'Zero research-readiness blockers and a disjoint frozen holdout.',
    'Eleven new preferences survive both A/B and B/A order.',
    'The training recipe is clean-tree, base-revision, dataset, and toolchain bound.',
    'Adapter activation and promotion remain forbidden until a held-out win exists.',
  ],
  proof: {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        'No adapter is active or promoted in the website. A reproducible research run and a frozen held-out base-versus-adapter-versus-reference comparison are the next gates; a loss keeps the public base-only route unchanged.',
      ],
    },
  ],
};
