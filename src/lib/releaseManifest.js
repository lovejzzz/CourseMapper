...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.65 Builds a Verified Course in 39 Seconds',
  highlights: [
  ...
  landingHighlights: [
    'A real 29-minute failure becomes a 39-second verified course build.',
    '10 distinct Environmental Chemistry lessons preserve the requested sequence.',
    '10/10 lesson kernels and 9/9 material families complete locally.',
    'Quality reaches 99/A with texture 94 and no visible findings.',
    'Verified ZIPs download even when review notes remain.',
    'The Agent answers supported course questions from compiled evidence.',
    'Progress stays transparent from model loading through final grading.',
    'Slide labels, lesson prose, materials, and assessments read cleanly.',
    '5,375 unit tests plus 25 real export scenarios protect the release.',
    'Gemma weights are unchanged and the research adapter remains inactive.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.65.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01665_PRODUCTION_LOG_RECOVERY.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Reproduce the production failure exactly',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'The attached log spans 1,756,578 ms and records 64 provider requests, 38 stream retries, four continuation retries, and three topic groups repeated across all 15 lessons.',
        'The run compiled every selected deliverable and passed 38/38 physical export checks, but a publish-readiness blocker disabled the only ZIP button; export validity and editorial readiness were incorrectly coupled.',
        'The incident is retained as a regression source rather than summarized away: continuation parsing, retry accounting, duplicate identity, grounding, finalizer recovery, and ZIP ownership each have a specific code or test response.',
      ],
    },
    {
      label: 'Replace retry volume with a fact-ledger architecture',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'The local model produces compact course and lesson facts; semantic admission freezes usable atoms and deterministic projection owns the repeated structure for lesson plans, slides, assignments, rubrics, discussions, quizzes, guides, FAQ, and export.',
        'Partial attempts retain stronger complete sections and admitted facts instead of throwing away the entire response. Transport retries are bounded and retry counters distinguish logical work from native generation attempts.',
        'Course-map continuation receives the existing lesson identities, remains on the course-map route, rejects duplicates before canonical admission, and returns rejected identities to the next bounded attempt.',
      ],
    },
    {
      label: 'Prove a new Environmental Chemistry course',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The new source shard links open EPA material into the Environmental Chemistry graph instead of loading an unrelated biology shard with zero concept overlap.',
        'The exact brief produces atmospheric chemistry, water quality, soil contaminants, toxicology, fate and transport, green chemistry, environmental sampling, risk assessment, environmental justice, and cumulative synthesis as ten distinct lessons.',
        'Weekly evidence-based lab analyses align every objective; Lesson 5 contains the midterm and Lesson 10 contains the cumulative final without triggering a false Bloom warning.',
      ],
    },
    {
      label: 'Measure the recovery in the browser',
      icon: 'LIVE',
      color: 'violet',
      items: [
        'A fresh cached-base run reaches Ready in 39 seconds with 10/10 knowledge kernels and 9/9 materials; the course grades 99/A with texture 94 and zero visible quality findings.',
        'Frame inspection covers the living progress surface, all ten material tabs, course map alignment, syllabus delivery language, lesson-plan materials and instructor notes, slide thumbnails, assignment criteria, Agent state, and export panel.',
        'The Living Course Compiler exposes observed progress through Model, Map, Enrich, Compile, Verify, and Grade and names the upcoming work during otherwise quiet frames.',
      ],
    },
    {
      label: 'Make export recovery real',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Exportability is derived from physical file verification, while publish readiness remains an honest editorial state; a safe archive is no longer trapped behind an unrelated content-review note.',
        'The single ZIP owner remains in the export panel. Existing V0.16.61–V0.16.63 receipts recover from persisted checked/failed counts without regenerating model work.',
        'All 25 Chromium export scenarios pass, including ZIP selection, draft-with-notes, blocked failures, selected-lesson scope, placeholder repair, rubric repair, DOCX, CSV, and PPTX downloads.',
      ],
    },
    {
      label: 'Connect the Agent without paying model latency twice',
      icon: 'LIVE',
      color: 'blue',
      items: [
        'Read-only lesson questions with an explicit comparison pair can resolve directly from the compiled course content index, producing an immediate grounded answer without starting the browser model.',
        'The fast path refuses edit intent, missing lesson identity, unsupported synthesis, and comparison pairs absent from the course evidence; those requests continue through the normal Scion Agent route.',
        'The exact Lesson 2 dissolved-oxygen and temperature question returns the course-supported comparison and physical interpretation instead of a slow partial answer about the wrong variables.',
      ],
    },
    {
      label: 'Remove visible compiler and UI defects',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Long rubric-style lab titles stay exact in identity surfaces but become Week N lab analysis in instructional prose, eliminating broken “explain. model.” sentence splices.',
        'Slide thumbnails prefer the slide title and shorten at a word boundary with an ellipsis; canonical material deduplication removes article-and-conjunction variants; syllabus delivery language is sentence-cased.',
        'Knowledge admission rejects incomplete fact and title tails. Assignment criteria render as real bullets, cumulative-exam Bloom validation recognizes multiple higher-order verbs, and repair counts use calm informational language.',
      ],
    },
    {
      label: 'Close the regression net without overstating the model',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'The complete unit suite covers 5,375 tests. The previously failing clinical stress audit now passes at 5, 8, and 14 lessons after lesson-specific readiness, feedback, rubric, and distractor language removed repeated boilerplate.',
        'The V16 held-out benchmark remains five-domain and task-disjoint and is rebound to the exact transitive grader implementation; it inherits no adapter score or promotion result.',
        'Gemma weights are unchanged, the roughly 105 MB research adapter remains inactive, and no backend model store was added. Shared admission, compiler, grading, Agent evidence, and export improvements also benefit compatible paid-provider output.',
      ],
    },
  ],
};
