...
export const CURRENT_RELEASE = {
  ...
  highlights: [
    ...
    'The activity briefing is an editable, responsive learner-facing surface with calm semantic color, role-only information, evidence cards, synchronized updates, one canonical clock, artifact requirements, and debrief prompts. Export keeps one coherent assignment packet instead of duplicating a second activity brief. A fresh browser run completed the full three-lesson package in 117.957 seconds at 99/A with Texture 96, zero findings, zero finish blockers or warnings, and no warning/error console entries; its physical ZIP passed integrity and structural audits and independently regraded 99/A with zero findings.',
    'Gemma weights remain unchanged and the research adapter remains inactive. The canonical activity IR, admission, compiler projections, grading, and export path are model-neutral and benefit compatible paid providers; browser download, WebGPU inference, local cache, and public-model routing remain Scion-specific.',
  ],
  landingHighlights: [
