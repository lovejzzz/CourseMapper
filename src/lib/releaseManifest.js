...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.69 Closes the Five-Domain Quality Freeze',
  highlights: [
    ...
    'Artifact inspection fixes defects that a 99/A score did not reveal: duplicated assessment weights, a severed misconception narrator, short-answer keys that copied learner directions, and shortened references with doubled articles, lowercase sentence starts, preposition-only labels, or broken possessives.',
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        'Compact focus labels discard introductory prepositions and possessive fragments, so “Introduction to Earth Systems,” “Review of Nutrient Functions,” and “Erikson’s Psychosocial Development” remain grammatical after repetition reduction.',
      ],
    },
    {
