...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.76 Freezes Five Domains at 99/A',
  highlights: [
  ...
  landingHighlights: [
    'Five frozen domains finish at 99/A in one exact base-only run.',
    'All 70 requested lessons and nine generated material families are ready.',
    'Every package has zero blockers, warnings, findings, or retries.',
    'All five archives pass 38/38 export checks and ZIP testing.',
    'The route uses 41 provider calls instead of a repair cascade.',
    'A real cold browser build downloads and exports successfully.',
    'Slide previews stay legible in dark and narrow workspaces.',
    'The adapter stays inactive and Gemma weights stay unchanged.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.76.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01676_BASE_FREEZE_ACCEPTANCE.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Freeze one exact ruler',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'V21 fixes the five course inputs, source packets, grader, compiler configuration, base model, and immutable revision.',
        'Mandarin, World Literature, Psychology, Nutrition, and Astronomy complete in one same-code run.',
        'The preserved V0.16.75 tag and commit remain immutable; V0.16.76 is a new freeze rather than rewritten evidence.',
        'No adapter, paid model, or inherited historical score participates in the production result.',
      ],
    },
    {
      label: 'Require green everywhere',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'All five courses reach 99/A with zero blockers, warnings, or learner-visible P0/P1/P2 findings.',
        'Every requested lesson and every lesson kernel completes; enrichment coverage is 100%.',
        'Each package reports 38 checked exports, zero failures, and zero warnings.',
        'No retry, repair-retry, or finish-retry model call is used.',
      ],
    },
    {
      label: 'Inspect the actual artifacts',
      icon: 'CHECK',
      color: 'violet',
      items: [
        'Rendered text is clear of known punctuation seams, raw modality IDs, malformed fragments, undefined values, and internal object strings.',
        'Source-backed teaching prose keeps complete comparisons instead of clipping coordinated claims.',
        'Discussion and quiz metadata retain natural grammar and punctuation after compaction.',
        'Five physical ZIPs extract cleanly and carry stable SHA-256 receipts.',
      ],
    },
    {
      label: 'Make visuals teach',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The frozen packages contain 589 structured teaching visuals across five domains.',
        'Visual plans bind evidence sources, artifact connections, student actions, and accessibility descriptions.',
        'Native PPTX rendering remains part of export verification rather than a decorative metadata claim.',
        'The web preview scales the fixed slide artboard as one unit and preserves authored light cards inside a dark workspace.',
      ],
    },
    {
      label: 'Prove the first-use browser',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'A new three-lesson Epidemiology course exercises the cold public-model download rather than a cached shortcut.',
        'The Living Course Compiler narrates model, map, enrichment, compilation, verification, and grade without false completion states.',
        'The Agent summarizes the compiled course through Scion and returns to Available.',
        'One browser download produces a valid 39-file package while the console remains free of warnings and errors.',
      ],
    },
    {
      ...
      color: 'violet',
      items: [
        'Gemma weights are unchanged; the optional research adapter remains inactive because it has not earned promotion.',
        'The compiler—not hidden fine-tuning—supplies the measured production quality lift.',
        'Compatible providers inherit shared compiler and export improvements while Scion alone owns the public browser-local runtime.',
        'This is a bounded five-course and browser proof—not universal factual correctness, instructor approval, classroom outcomes, adapter superiority, or paid-reference parity.',
      ],
    },
  ],
};
