...
export const CURRENT_RELEASE = {
  ...
  highlights: [
    ...
    'Scion now recognizes a strict exact-count, explicitly named lesson sequence before importing the browser runtime or touching model storage. It compiles a typed course skeleton with `scion-compiler-explicit-sequence-route-v1`, preserves the instructor’s order, and fails closed to the existing Gemma route when the brief is incomplete, ambiguous, or does not match its declared count.',
    ...
    'A fresh local browser replay produced the same four-lesson Digital Accessibility package in eight seconds on the first run and four seconds with the evidence cache warm, with 0 provider starts, 0 model calls, 4/4 kernels, 9/9 materials, 69/100 readiness, 99/A conformance, texture 97, 38/38 export checks, six trusted sources, and complete 48/48 source-reference coverage. This is route evidence, not a perfectly controlled cold-latency comparison.',
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        'The local browser replay reached ready in eight seconds on its first run and four seconds with warm evidence while preserving every measured package result.',
