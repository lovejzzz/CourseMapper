...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.73 Audits the Package Behind the Score',
  highlights: [
  ...
  landingHighlights: [
    'The browser journey is judged frame by frame, not by one score.',
    'Astronomy finishes at 99/A with a warning-free physical ZIP.',
    'All ten material families receive direct content inspection.',
    'FAQ advice respects the real course domain.',
    'Agent answers use course evidence without leaking internal notes.',
    'Non-applicable materials remain polished and warning-free.',
    'The complete stable suite passes 5,449 tests.',
    'The adapter stays inactive and Gemma weights stay unchanged.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.73.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01673_BROWSER_ACCEPTANCE.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Judge the actual browser experience',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'A fresh browser-local Astronomy build traverses Model, Map, Enrich, Compile, Verify, and Grade before reaching Ready to export.',
        'The Syllabus, Course Map, Lesson Plans, Slide Decks, Assignment Briefs, Rubrics, Discussions, Quiz Bank, Study Guides, FAQ, and Agent are inspected directly.',
        'At 1024px the workspace switches between full-width Content, Agent, and Export modes instead of compressing three unreadable rails into one row.',
        'The final package is 99/A with zero P0/P1/P2 findings and a valid 25-file archive.',
        'Package manifest readiness reports ten checked sections, zero blockers, and zero warnings.',
      ],
    },
    {
      label: 'Make green match learner-facing quality',
      icon: 'CHECK',
      color: 'violet',
      items: [
        'Astronomy explanations retain observable facts and explicit misconception boundaries instead of generic instructional filler.',
        'Discussion and assessment copy distinguish formative practice from graded examinations.',
        'Slide agendas normalize evidence anchors before adding punctuation, removing visible comma-period seams.',
        'Artifact checks distinguish real prose defects from legitimate citation and abbreviation punctuation.',
      ],
    },
    {
      label: 'Keep FAQ and Agent behavior contextual',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'A dataset or observing notebook does not turn Astronomy into a programming course without a real software, coding, or computational signal.',
        'The FAQ keeps access, materials, observation, and assessment guidance in the actual course context.',
        'Agent answer selection rejects timestamps, facilitation notes, group choreography, and internal imperative prompts.',
        'A compiled-evidence answer names where the supporting course materials live without another provider call.',
      ],
    },
    {
      label: 'Export applicable artifacts honestly',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Compiler-routed non-applicable assignments render one polished narrative artifact instead of empty CSV and PDF variants.',
        'Criterionless exam rubric handoffs point to the answer key and likewise avoid meaningless empty export variants.',
        'Applicable material families retain the complete DOCX, CSV, PDF, PPTX, and package verification contract.',
        'The final green package contains no readiness report because it has no blocker or warning to report.',
      ],
    },
    {
      label: 'Stabilize the evidence system',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'Grader 1.10.34 and held-out benchmark V20 record the exact implementation hash behind the result.',
        'The stable suite passes 441 files and 5,449 tests with no assertion or content failure.',
        'Vitest uses four workers and realistic integration limits, preventing machine saturation from creating false red runs.',
        'Browser frames, content queries, Agent evidence, the downloaded archive, and release gates are retained as one acceptance record.',
      ],
    },
    {
      ...
      items: [
        ...
        'Shared compiler changes benefit compatible providers, while browser download, local inference, and exact Scion ledgers remain route-specific.',
        'This is automated artifact and browser evidence—not universal factual correctness, instructor approval, classroom outcomes, adapter superiority, or paid-reference parity.',
      ],
    },
  ],
};
