...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.63 Keeps Every Lesson in Its Own World',
  highlights: [
  ...
  landingHighlights: [
    'Lesson knowledge is admitted only when it belongs to that lesson.',
    'Four measured cross-lesson contamination families fall to zero.',
    'Explicit instructor-authored lesson sequences become enforced source truth.',
    'Weak labels and false-friend sources can no longer seed a course.',
    'Canonical titles stay exact while working prose becomes compact and natural.',
    'Lesson-aware compiler variants raise texture without adding model calls.',
    'Short author names and acronyms survive Agent objective matching.',
    'A fresh six-lesson package reaches 99/A and texture 96 with zero export warnings.',
    'Benchmark V14 binds the stricter lesson-sequence ruler without inheriting a score.',
    'Gemma weights are unchanged and the adapter remains inactive.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.63.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01663_EXPERIENCE_AUDIT.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Enforce lesson identity end to end',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'Genome enrichment is revalidated against title, objectives, topic, and instructor-named readings before persistence, cache reuse, compilation, and final projection.',
        'Generic descriptor overlap cannot manufacture relevance; a rejected concept removes its dependent facts, citations, scenarios, questions, rationales, and derived references as one semantic unit.',
        'Exact-twin measurement reduces four named World Literature contamination families from 40/52/33/29 document occurrences to 0/0/0/0 and removes twelve repeated expert-thinking deck labels.',
      ],
    },
    {
      label: 'Preserve the course the instructor actually requested',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'The explicit-sequence parser recognizes narrow semicolon and numbered schedule forms without mistaking ordinary prose for a lesson list.',
        'Planning, continuation, public-provider parsing, and grading share the same sequence contract; both “through” and hyphenated continuation ranges are supported.',
        'Grader 1.10.24 treats missing, merged, shifted, or duplicated requested lessons as a release-blocking sequence defect.',
      ],
    },
    {
      label: 'Repair weak identities before they spread',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'One-word scaffolds are replaced with the specific lesson identity before they influence concepts, assessments, source retrieval, or filenames.',
        'Literature fallback tasks ask for passage evidence, comparison, interpretation, and limits instead of a generic course decision.',
        'Source Finder V6 prefers the lesson title, filters weak concepts, and requires a discriminative topic or exact named-course match, closing the audited false-friend paths.',
      ],
    },
    {
      label: 'Keep exact identity without template-like prose',
      icon: 'LIVE',
      color: 'violet',
      items: [
        'Course Map rows, headings, provenance, and related-lesson identity keep the canonical title verbatim.',
        'Repeated instructions, criteria, milestones, quiz scaffolds, and support copy use compact lesson and artifact references instead of reciting an eight-word title.',
        'The live Assignment Brief export moved from one 12-copy title warning, through a newly exposed 19-copy short-title edge case, to zero export warnings without weakening the audit.',
      ],
    },
    {
      label: 'Raise texture and trust together',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Study guides, artifact connections, slide objectives, agendas, transitions, expectations, and feedback rotate through lesson-aware compiler variants.',
        'Objective-to-assessment alignment is recomputed after repair so stale positive prose cannot contradict the repaired course map.',
        'Short proper names and acronyms survive Agent tokenization, removing the false Li Bai and Du Fu objective warning without suppressing real gaps.',
      ],
    },
    {
      label: 'Prove the browser and exported package',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'A fresh exact-base World Literature build completed six lessons in roughly 40 seconds with 6/6 kernels and 9/9 compiled material families.',
        'The deterministic grader reports 99/A and texture 96 with zero encoded P0/P1/P2 findings; one grade-16.4 quiz readability recommendation remains advisory.',
        'The downloaded 53-file ZIP passes independent archive inspection, all 38 export checks pass, and exact-title counts in the affected Assignment Briefs fall to three or fewer canonical/cross-lesson identity uses.',
      ],
    },
    {
      label: 'Freeze the next honest ruler',
      icon: 'LIVE',
      color: 'blue',
      items: [
        'Held-out V14 keeps the five frozen domains and exact base contract while binding grader 1.10.24, texture 1.1.0, and explicit-sequence enforcement.',
        'V14 inherits no V13 score, adapter win, or promotion result. A fresh exact-lineage candidate must still win across domains with equal or lower compiler burden.',
        'Gemma weights are unchanged, the current research adapter is inactive, and this release is compiler evidence—not paid-reference parity, factual validation, or classroom proof.',
        'Compatible paid routes inherit the model-neutral semantic and compiler improvements; WebGPU loading, local caching, and future adapter delivery remain Scion-specific.',
      ],
    },
  ],
};
