...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.62 Trains the Right Task and Refines the Whole Course',
  highlights: [
    ...
    'Typed compiler boundaries now collapse mirrored assessment titles and render structured citations as human source labels, preventing repeated export phrases and visible `[object Object]` leaks.',
  ...
  landingHighlights: [
    'The qualified source-grounded corpus reaches 102 lessons across seven domains.',
    'One hundred group-disjoint production rows train the first task-matched research adapter.',
    'A real training run improves validation loss, but does not inherit a quality claim.',
    'The adapter route is narrowed to the exact source-grounded task it learned.',
    'Every native retry is counted in matched efficiency evidence.',
    'The first five-course pair saves inference but does not improve aggregate quality.',
    'Kernel retention, assessment depth, language pairing, and humanities texture improve.',
    'Repeated assessment titles and visible object leaks are blocked before export.',
    'A new V13 ruler binds the stricter grader and texture metric.',
    'Gemma weights are unchanged and the adapter remains inactive.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.62.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01662_EXPERIENCE_AUDIT.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Cross the first real data threshold',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'A targeted 56-case wave contributes 55 qualified source-grounded preferences and quarantines one unresolved case.',
        'The cumulative ruler reaches 102 qualified lessons; the production dataset retains 100 rows after exact deduplication and complete course-group splitting.',
        'All seven training domains and all nine diagnosed failure families remain represented without crossing the five-domain held-out boundary.',
      ],
    },
    {
      label: 'Train, but do not overclaim',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'The first production-shaped 200-iteration research run reduced validation loss from 1.555 to 1.089 and packaged an independently downloadable learned delta of roughly 105 MB.',
        'The adapter remains a research artifact because loss reduction proves learning mechanics, not that users receive better held-out courses.',
        'Gemma base weights remain public and unchanged; adapter activation stays integrity-checked, optional, reversible, and off by default.',
      ],
    },
    {
      label: 'Route the task the adapter actually learned',
      icon: 'LIVE',
      color: 'blue',
      items: [
        'A live run was stopped when open fact synthesis was accidentally routed through an adapter trained only on numbered source ledgers; no score or adapter win was fabricated from it.',
        'Base Gemma owns course mapping and fact synthesis. The compiler admits and freezes those facts before the adapter may author a source-grounded lesson kernel.',
        'Route receipts retain task family, adapter identity, and every native retry so efficiency cannot be inflated by counting only transport requests.',
      ],
    },
    {
      label: 'Let matched evidence say no',
      icon: 'CHECK',
      color: 'amber',
      items: [
        'The five-course V12 pair produced two publishable courses in each arm. Adapter execution used 114 native attempts versus 233 and finished 8.5% faster overall.',
        'World Literature gained one point, three domains were quality-flat, and Mandarin fell from 99/A to 89/B because one lesson lost visible Hanzi–Pinyin pairing.',
        'That is a credible efficiency signal and a failed quality promotion. The adapter remains inactive until a fresh V13 pair wins across domains without new burden.',
      ],
    },
    {
      label: 'Make the compiler keep better knowledge',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Attempt selection no longer lets a surface-rich but unusable partial outrank a compact model kernel that deterministic completion can safely finish.',
        'Grounded relation pairs, cumulative prior concepts, admitted assessment atoms, and target-language pairings survive staging, recovery, and project restore.',
        'Fallback assessments and explanations rotate through distinct instructional forms, and interpretive courses receive less repetitive prose and more purposeful visual structures.',
      ],
    },
    {
      label: 'Make exports and the judge see typed defects',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'Mirrored assessment titles are collapsed at the typed blueprint boundary before one bad registry value can repeat through a lesson-plan section.',
        'Structured citation objects become human source labels instead of JavaScript coercion text such as `[object Object]`.',
        'Grader 1.10.23 catches both defects, texture 1.1.0 ignores structural chrome, and held-out benchmark V13 binds the complete transitive implementation without inheriting an earlier score.',
      ],
    },
    {
      label: 'Keep the architecture honest',
      icon: 'LIVE',
      color: 'blue',
      items: [
        'Scion remains pinned public Gemma 4 E2B plus the model-neutral compiler in production; the experimental adapter is not downloaded or activated for users.',
        'Compatible paid-model routes inherit the shared admission, compiler, grading, texture, and export improvements, while WebGPU loading, caching, and future adapter routing remain Scion-specific.',
        'Same-identity model judging is reported as single-model evidence—not as human review, independent validation, classroom proof, or paid-reference parity.',
        'The final exact-base browser audit admitted 14/14 World Literature kernels and exported 117 ZIP entries at 98/A with 90/A texture, zero encoded findings, and zero export warnings in 183 seconds at $0.',
        'Corrected Vite ownership reduces the initial landing route from about 2.1 MiB to 251.4 KiB raw / 79.4 KiB gzip while keeping generation-only systems lazy.',
      ],
    },
  ],
};
