...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.74 Builds, Remembers, Answers, and Exports the Exact Course',
  highlights: [
  ...
  landingHighlights: [
    'World Literature finishes at 99/A with zero findings.',
    'All eight named readings survive into the course.',
    'Comparative assignments preserve the exact required pairs.',
    'Agent answers use compiled course evidence without another model call.',
    'Exact anonymous projects resume without recompiling.',
    'Resumed packages retain their 38/38 export receipt.',
    'Desktop and phone-size workflows stay clear and downloadable.',
    'The adapter stays inactive and Gemma weights stay unchanged.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.74.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01674_BROWSER_ACCEPTANCE.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Preserve the instructor contract',
      icon: 'PROOF',
      color: 'emerald',
      items: [
        'All eight exact World Literature readings remain visible in the Syllabus and package manifest.',
        'Assessment weights remain Comparative Reading Responses 30%, Midterm 15%, and Final Comparative Paper 55%.',
        'The two required comparison pairs are routed explicitly instead of inferred from generic weekly topic language.',
        'Comparative criteria require both texts, paired locatable evidence, a credible counter-reading, revision, and an explicit evidentiary limit.',
      ],
    },
    {
      label: 'Make the course answerable',
      icon: 'CHECK',
      color: 'violet',
      items: [
        'The Agent resolves the requested comparison to Lesson 2 and Assignment Briefs from compiled project evidence.',
        'Its answer states the paired-passage, counter-reading, revision, and claim-limit contract concisely.',
        'The named-reading path avoids article stutter and uses no provider call when the answer is already present.',
        'Whole-course schedule and assigned-reading questions use a separate 1.7 KiB demand-loaded capability, keeping ordinary Agent questions and the landing route lean.',
        'Study guides, discussions, FAQ copy, briefs, and rubrics retain the exact named-reading spelling and course context.',
      ],
    },
    {
      label: 'Resume the exact finished project',
      icon: 'CHECK',
      color: 'blue',
      items: [
        'Oversized anonymous autosaves use exact IndexedDB storage instead of discarding compiled deliverables to fit localStorage.',
        'localStorage keeps a small marker and compact recovery fallback, preserving graceful behavior when IndexedDB is unavailable.',
        'A real reload restores the complete 5.5 MB project, 99/A receipt, and all nine material families in about 1.9 seconds.',
        'Resume performs no model repair, lesson-plan regeneration, or quality recompile.',
      ],
    },
    {
      label: 'Export the same verified package',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Resumed exports use the restored run digest when the live reference has not yet been populated.',
        'The downloaded manifest records export verification passed with 38 checked, zero failed, and zero warnings.',
        'The physical ZIP passes compressed-data testing and macOS archive extraction with its Unicode filenames intact.',
        'The adoption audit reports no blocking reason; its classroom-ready cap reflects absent external professor and source-benchmark evidence, not a package defect.',
      ],
    },
    {
      label: 'Judge every surface',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'The first-use path exposes model download, preparation, mapping, enrichment, compilation, verification, and grading as one honest progress journey.',
        'A cached fresh run finishes in 51 seconds with one map generation and eight lesson enrichments rather than a rewrite cascade.',
        'Desktop and 390×844 phone-size Content, Agent, and Export modes remain legible, reachable, and warning-free.',
        'Browser state, direct content queries, the Agent answer, IndexedDB recovery, and the physical archive are retained as one acceptance record.',
      ],
    },
    {
      ...
      color: 'violet',
      items: [
        'The evaluated base is google/gemma-4-E2B-it-qat-q4_0-unquantized at immutable revision 1ca4dd94b623b6e0dd9da00c2239ab84b4f3e5ce.',
        'The 40-course contract caught and removed a false linear-algebra example from an Information Literacy synthesis-matrix lesson while genuine quantitative courses remained green.',
        'The former one-assessment hang input now repairs to full lesson coverage and passes the semantic compiler contract with zero blockers before rendering.',
        'Gemma weights are unchanged; the optional research adapter remains inactive because it has not earned promotion.',
        'Shared reading, assessment, compiler, Agent-evidence, persistence, grader, and export changes benefit compatible providers; browser download and local inference remain Scion-specific.',
        'This is automated browser and artifact evidence—not universal factual correctness, instructor approval, classroom outcomes, adapter superiority, or paid-reference parity.',
      ],
    },
  ],
};
