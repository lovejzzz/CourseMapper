  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        'Fast verification no longer depends on an ignored local organizer packet. Both paired-order audits deterministically rebuild the 120-case packet from tracked inputs before reconstructing the workbooks, and reconstruction selects the receipt-bound historical task-guide wording so a later decision-token clarification cannot invalidate an already sealed campaign.',
