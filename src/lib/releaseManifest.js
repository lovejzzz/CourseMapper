...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.70 Restores Construct-Valid Rubrics',
  highlights: [
  ...
  landingHighlights: [
    'The selective adapter loses its matched quality-and-efficiency gate and stays inactive.',
    'Rubrics score evidence, analysis, communication, and revision—not file-format compliance.',
    'Brief requirements stay visible as clear unweighted checks.',
    'The compiler improvement adds zero model calls and benefits compatible providers.',
    'Astronomy and Mandarin stay 99/A with zero findings and verified ZIPs.',
    'Six rubric pages render without clipping, overlap, or a split Weight heading.',
    'The attached Geology exam omission is closed by exact regression and fresh zero-finding browser proof.',
    'Verified archives use premium finished-product language and one Download ZIP action.',
    'Gemma weights remain unchanged.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.70.json',
    roadmap: 'docs/SCION_ADAPTER_ROADMAP.md',
    browser: 'docs/evidence/SCION_V01670_ADAPTER_REJECTION_AND_RUBRIC_VALIDITY.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Reject the adapter on learner-facing evidence',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'Base and candidate use the same V17 inputs, pinned Gemma revision, compiler, grader, and task-scoped route contract.',
        'World Literature prefers base 64–46 and 57–44; Astronomy prefers base 71–55 and 61–50 across reversed anonymous orders.',
        'Mandarin splits with presentation order, and the candidate propagates a false claim that 地铁 is the destination in 我坐地铁去学校.',
        'Psychology and Nutrition have no changed learner-facing artifact, so they provide no candidate benefit.',
      ],
    },
    {
      label: 'Keep browser cost inside the product contract',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'The candidate uses 59 native generations versus 31 for base-only Scion and takes 2.81 times the total measured runtime.',
        'Its 105,459,677-byte delta is larger than the current 64 MiB browser adapter budget.',
        'Training loss and a valid package are not promotion evidence; the adapter remains unavailable to production users.',
      ],
    },
    {
      label: 'Restore the rubric’s learning construct',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The old compiler turned scope, output format, and evidence-presence parameters into 60% of a scored rubric and removed analysis and revision.',
        'Those parameters now remain verbatim as unweighted submission checks, visible before scoring.',
        'The actual 30/30/20/20 evidence, analysis, communication, and feedback-informed revision criteria retain the full 100-point construct.',
        'The repair occurs in deterministic compilation and adds no model call.',
      ],
    },
    {
      label: 'Render the matrix as a finished document',
      icon: 'PROOF',
      color: 'violet',
      items: [
        'The weight column grows from 750 to 930 DXA while the total landscape grid remains exactly 9360 DXA.',
        'Weight headings and values are centered; the heading stays on one line and repeats on subsequent pages.',
        'All three pages of an Astronomy rubric and all three pages of a Mandarin rubric were rendered and inspected at full resolution.',
        'No page clips, overlaps, loses its table header, breaks the grid, or shows a missing glyph.',
      ],
    },
    {
      label: 'Re-prove the complete package path',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'Fresh Astronomy completes in 70 seconds with seven native generations; Fresh Mandarin completes in 59 seconds with two native generations.',
        'Both packages reach 99/A with zero P0/P1/P2 findings, blockers, warnings, or retry calls.',
        'Both pass all 38 export checks, and their ZIPs open to 101 and 127 files.',
      ],
    },
    {
      label: 'Close the attached Geology failure as a finished product',
      icon: 'CHECK',
      color: 'emerald',
      items: [
        'The supplied V0.16.67 ZIP is physically valid and passes 38/38 export checks, but its registered Final (50%) entry never appears in the exam document; that is the real 74/C P0.',
        'The exact contradictory graded-artifact versus exam-title case is locked by the Physical Geology compiler regression.',
        'A fresh corrected browser package reaches 99/A with zero P0/P1/P2 findings, blockers, warnings, console errors, or archive errors and opens to 117 files.',
        'The quality chip, Living Course Compiler, Agent, and export panel now use Quality refinement, Package refinement, Refine package, and Download ZIP; a verified ZIP is never branded as a draft.',
      ],
    },
    {
      label: 'Keep the model claim boundary exact',
      icon: 'PROOF',
      color: 'blue',
      items: [
        'The pinned public Gemma 4 E2B weights are unchanged and the research adapter remains inactive.',
        'Rubric compilation and DOCX rendering are model-neutral; compatible paid-provider routes receive the same repair.',
        'The complete local gate passes 434 test files and 5,327 tests, formatting, lint, production build, locked bundle budgets, and the release-history audit; initial landing JavaScript remains 250.7 KiB raw / 79.3 KiB gzip.',
        'The result proves this artifact defect and these packages—not factual correctness for every course, instructor approval, classroom outcomes, paid-model parity, or a universal 99/A promise.',
      ],
    },
  ],
};
