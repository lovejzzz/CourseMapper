...
export const CURRENT_RELEASE = {
  ...
  landingTitle: 'Scion V0.16.55 Keeps Scope, Time, and Readiness Honest',
  highlights: [
  ...
  landingHighlights: [
    'A focused Lesson 5 build stays Lesson 5 through export.',
    'The selected class clock controls compilation and grading.',
    'Completed build time stays stable during post-build checks.',
    'Ready-with-notes reads as completion, not a warning.',
    'Desktop, phone, light, dark, recovery, and export were replayed.',
    'The real package reached 89/B with zero blockers and 22 clean checks.',
    'Gemma weights remain unchanged and no quality adapter is active.',
  ],
  proof: {
    contract: 'release-contracts/v0.16.55.json',
...
export const CURRENT_RELEASE_CHANGELOG = {
  ...
  sections: [
    {
      label: 'Keep focused scope visible and true',
      icon: 'SCOPE',
      color: 'blue',
      items: [
        'Setup preview resolves the actual selected source lesson before generation and reports one item with singular grammar. Selecting Lesson 5 no longer previews Lesson 1 merely because the compact compiler receives one local item.',
        'A single materialized-scope boundary maps compact working indexes back to authoritative source lesson numbers before every deterministic finish and again after targeted recovery.',
        'Course Map rows, Lesson Plan week labels, readiness evidence, and downstream deliverables retain sourceLessonNumber so stale React state cannot overwrite repaired identity during retry.',
        'Package paths and the manifest preserve Lesson05 and `lessonScope: [5]`, including restored compact workspaces whose caller no longer supplies the original filter.',
      ],
    },
    {
      label: 'Make the classroom clock authoritative',
      icon: 'TIME',
      color: 'violet',
      items: [
        'The UI session-length selection is normalized into a typed 20–240 minute generation constraint instead of ending at a decorative setup control.',
        'Generation, package finalization, retry, the final quality gate, and ZIP assembly all receive the same expected sessionMinutes value.',
        'Deep grader 1.10.17 compares declared duration, lesson-outline total, and the expected UI clock. A mismatch is a P0 readiness failure rather than a quiet note.',
        'The real Marketing replay compiled six phases of 7, 8, 9, 10, 9, and 7 minutes—exactly the requested 50-minute class.',
      ],
    },
    {
      label: 'Make completion look and behave complete',
      icon: 'READY',
      color: 'emerald',
      items: [
        'A downloadable package with P1 or P2 review notes now says Work complete, Package ready, and Ready to download. Review saved notes before publishing.',
        'Calm blue information treatment communicates retained review notes; amber remains reserved for blocked or unfinished work that actually needs intervention.',
        'The Agent Check lesson timing command is connected to the active Course Map and Lesson Plans, producing a scoped deterministic audit rather than inspecting unrelated package surfaces.',
        'Finishing an already materialized package or running a post-build check is tagged as post-build activity, so the Living Course Compiler elapsed time remains the cost of the build itself.',
      ],
    },
    {
      label: 'Replay the real workflow frame by frame',
      icon: 'LIVE',
      color: 'blue',
      items: [
        'The saved Marketing workspace was imported, recovered, finished, graded, inspected, and exported through the production bundle rather than a component-only story.',
        'Desktop replay reached 89/B with zero P0 blockers and consistency 100/A. Lesson Plans visibly showed Lesson 5, Week 5, and 50 minutes before export.',
        'A second replay used a real 390×844 Chromium viewport at device scale factor two. Landing, import recovery, Content, Agent, Export, finish, and download all remained operable with zero page-level horizontal overflow.',
        'The same phone workspace was inspected in light and dark modes; completed, review, selected, and export states remained distinguishable without warning-colored success language.',
      ],
    },
    {
      label: 'Verify the exported evidence—and keep the boundary honest',
      icon: 'PROOF',
      color: 'amber',
      items: [
        'The phone-generated archive passed 22 of 22 export checks with zero failures and zero warnings. Its embedded quality result is 89/B, grader 1.10.17, with zero P0 findings.',
        'The manifest records `lessonScope: [5]` and `generationConstraints.sessionMinutes: 50`; Lesson Plan, Assignment, Rubric, and Quiz paths all use Lesson05.',
        'One P1 and three P2 findings remain visible: a syllabus registry identity gap, an assignment reverse-stamp note, two in-class assessments without dedicated artifacts, and texture 74. They are legitimate review work, not release blockers or hidden success.',
        'No hosted adapter is active, no Gemma weight changed, and no paid-reference parity, human validation, instructor validation, classroom validation, or adapter win is claimed.',
        'The source, scope, compiler, retry, grader, and export changes are shared infrastructure and therefore benefit paid-model routes; browser-local inference and a future adapter activation remain Scion-specific.',
      ],
    },
  ],
};
