...
describe('validateCourseMap', () => {
    ...
    it('auto-fills missing courseName and semester', () => {
        const map = {
            lessons: [
                { title: 'L1', sections: [{ learningGoals: 'A', topicSection: 'B', learningObjectives: 'C' }] },
            ],
        };
        const { valid, warnings } = validateCourseMap(map, columns);
        expect(valid).toBe(true);
    ...
    it('auto-fills missing lesson title', () => {
        const map = {
            ...
            semester: 'FA25',
            lessons: [
                { title: '', sections: [{ learningGoals: 'A', topicSection: 'B', learningObjectives: 'C' }] },
            ],
        };
        const { valid, warnings } = validateCourseMap(map, columns);
        expect(valid).toBe(true);
    ...
    it('converts flat lesson keys to sections format', () => {
        const map = {
            ...
            semester: 'FA25',
            lessons: [
                { title: 'L1', learningGoals: 'Goal', topicSection: 'Topic', learningObjectives: 'Obj' },
            ],
        };
        const { valid, warnings } = validateCourseMap(map, columns);
        expect(valid).toBe(true);
    ...
    it('adds missing column keys to sections', () => {
        const map = {
            ...
            semester: 'FA25',
            lessons: [
                { title: 'L1', sections: [{ learningGoals: 'A' }] },
            ],
        };
        const { valid, warnings } = validateCourseMap(map, columns);
        expect(valid).toBe(true);
