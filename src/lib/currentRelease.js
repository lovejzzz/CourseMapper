...
export const CURRENT_RELEASE = {
  ...
  highlights: [
    ...
    'Teach concrete reasoning with worked examples, a separate practice case, matching answers, diagnostic feedback and four-level rubrics. Improve real Word, PDF and PowerPoint exports.',
