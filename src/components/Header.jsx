          ...
          <div className="flex items-center gap-2">
            ...
            {developerMode && onOpenDeveloperPanel && (
              <button
                ...
                className="tactile hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-pill text-xs font-semibold text-indigo-600 bg-indigo-50/80 border border-indigo-200/50 hover:bg-indigo-100/80 hover:border-indigo-300/60 dark:hover:border-indigo-500/40 shadow-glass transition-all duration-300 disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-400 disabled:shadow-none"
              >
            ...
            {onOpenHelp && (
              <button
                onClick={onOpenHelp}
                className="tactile group flex items-center gap-2 px-4 py-2 rounded-pill text-xs font-semibold text-slate-500 bg-white/50 border border-slate-200/40 hover:bg-indigo-50/70 hover:text-indigo-600 hover:border-indigo-200/50 shadow-glass hover:shadow-glow-indigo transition-all duration-300"
              >
                <svg
