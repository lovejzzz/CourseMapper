      ...
      <div className="flex min-w-0 gap-1.5 overflow-x-auto pb-0.5">
        {items.map((item) => (
          <button
            ...
            title={item.title}
            className={`tactile inline-flex min-h-[28px] shrink-0 items-center gap-1.5 rounded-lg border px-2.5 py-1 text-[11px] font-bold shadow-sm transition-all disabled:cursor-not-allowed disabled:opacity-50 ${
