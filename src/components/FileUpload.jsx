...
export default function FileUpload({ files, setFiles }) {
  ...
  return (
    <div className="glass panel-glow rounded-squircle shadow-glass p-7 animate-stagger-2">
      ...
      <div
        ...
        className={`tactile border-2 border-dashed border-slate-200/60 rounded-squircle-sm text-center hover:border-indigo-400/50 hover:bg-indigo-50/20 transition-all duration-300 cursor-pointer group ${files.length > 0 ? 'py-3 px-4 flex items-center justify-center gap-3' : 'p-8'}`}
