...
// ─── Study Guides ───
export default function StudyGuidesView({ data, isStreaming, onEdit, regeneratingIndex, onRegenerateLesson, activeTier, freshLessonIndices, proposals, onAcceptProposal, onDismissProposal, onRegenerateProposal }) {
  ...
  return (
    <div className="space-y-3 p-4">
      {guides.map((baseG, i) => {
        ...
        const g = (currentTier !== 'standard' && baseG.tiers?.[currentTier]) ? { ...baseG, ...baseG.tiers[currentTier] } : baseG;
