...
// ─── Discussion Prompts ───
export default function DiscussionsView({ data, isStreaming, onEdit, regeneratingIndex, onRegenerateLesson, isStudentView, onSaveToBank, activeTier, freshLessonIndices, proposals, onAcceptProposal, onDismissProposal, onRegenerateProposal }) {
  ...
  return (
    <div className="space-y-3 p-4">
      {discussions.map((baseD, i) => {
        ...
        const d = (currentTier !== 'standard' && baseD.tiers?.[currentTier]) ? { ...baseD, ...baseD.tiers[currentTier] } : baseD;
