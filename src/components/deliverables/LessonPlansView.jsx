...
// ─── Lesson Plans ───
export default function LessonPlansView({ data, isStreaming, onEdit, regeneratingIndex, onRegenerateLesson, activeTier, freshLessonIndices, proposals, onAcceptProposal, onDismissProposal, onRegenerateProposal }) {
  ...
  return (
    <div className="space-y-3 p-4">
      {plans.map((basePlan, i) => {
        ...
        const plan = (currentTier !== 'standard' && basePlan.tiers?.[currentTier]) ? { ...basePlan, ...basePlan.tiers[currentTier] } : basePlan;
