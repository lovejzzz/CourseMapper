...
// ── Reference file upload (optional, per deliverable) ─────────────────────────

function ReferenceFileUpload({ featureId, config, onChange }) {
  ...
  return (
    <div className="pt-1 border-t border-slate-100/60">
      <p className="text-xs font-medium text-slate-600 mb-1.5">
        Reference file
        <span className="ml-1.5 text-[10px] font-normal text-slate-400">optional — show the AI an example of what you want</span>
      </p>
      {file ? (
    ...
    case 'courseMap':
      return (
        <div className="space-y-3">
          <p className="text-[11px] text-slate-500">Choose which columns to include in your course map. Drag to reorder.</p>
    ...
    case 'lessonPlans':
      return (
        <div className="space-y-4">
          ...
          <ReferenceFileUpload featureId={featureId} config={config} onChange={onChange} />
        </div>
      );
