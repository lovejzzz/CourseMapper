...
// ../../../../private/tmp/edutool-sampling-review/source/src/glue/messages.ts
var GLUE_VERSION = 3;
...
// ../../../../private/tmp/edutool-sampling-review/source/src/glue/glue.ts
...
// ../../../../private/tmp/edutool-sampling-review/source/src/utils.ts
...
var WLLAMA_ASYNCIFY_SINGLE_THREAD_CODE = 'throw new Error("This candidate supports JSPI single-thread only");';
var WLLAMA_ASYNCIFY_MULTI_THREAD_CODE = 'throw new Error("This candidate supports JSPI single-thread only");';

// ../../../../private/tmp/edutool-sampling-review/source/src/worker.ts
...
// ../../../../private/tmp/edutool-sampling-review/source/src/cache-manager.ts
...
// ../../../../private/tmp/edutool-sampling-review/source/src/model-manager.ts
...
// ../../../../private/tmp/edutool-sampling-review/source/src/wllama.ts
...
var Wllama = class {
   ...
   * @param tokens
   */
  async samplingAccept(tokens, acceptGrammar = false) {
    this.checkModelLoaded();
    const result = await this.proxy.wllamaAction(
      "sampling_accept",
      {
